...
question_store = {
    "question1": [
        ...
        "Lake Kariba",
        """If your answer followed the same rule as the two, 
                  then you're on the right track, but think a little bigger.""", 0,
        {
            "type": "link",
            "content": "None",
            "text": "Correct!",
    ...
    "question2": [
        ...
        "Jabberwocky",
        "When I say 'first', I really just mean it's the first one listed.", 0,
        {
            "type": "string",
    ...
    "question3": [
        ...
        "Vulcan Point",
        """Make sure you're using the name that refers to the 'bee' 
            specifically (it's two words).""", 0,
        {
            "type": "string",
    ...
    "question4": [
        ...
        "Gene Kranz",
        """How difficult you find this clue might depend on your 
